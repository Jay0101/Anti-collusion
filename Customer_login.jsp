                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <li><a href="cart.html"><i class="fa fa-user"></i> Manager Login</a></li>
            ...
            <div class="row">	   
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
						...
						<li class="dropdown dropdown-small">
                                <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" href="#"><span class="key">Categories :</span><span class="value">DTH </span><b class="caret"></b></a>
                                <ul class="dropdown-menu">
                                    <li><a href="shop.html">Mobiles</a></li>
                                    <li><a href="shop.html">DTH</a></li>
                                    <li><a href="shop.html">Data Cards</a></li>
                                </ul>
                            </li>
